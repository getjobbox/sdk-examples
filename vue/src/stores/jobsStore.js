...
export function seedDetail(job) {
  ...
  // Don't overwrite a fresher/fuller cached detail with a thin list card.
...
/**
 * Returns cached list when fresh; otherwise fetches (deduped).
 * Callers should peekList() first to paint cached data without a skeleton.
 */
