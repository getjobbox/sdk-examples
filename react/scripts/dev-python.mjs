/**
 * Run React (Vite) + Python getjobbox API proxy for the jobs demo.
 * Frontend: http://localhost:5176  ·  API: http://127.0.0.1:5177
 */
...
const uiPort = String(process.env.PORT || '5176')
const apiHost = process.env.PYTHON_API_HOST || '127.0.0.1'
const apiPort = String(process.env.PYTHON_API_PORT || process.env.PORT_API || '5177')
...
console.log(`JobBox React jobs demo (Python SDK) → http://127.0.0.1:${uiPort}`)
