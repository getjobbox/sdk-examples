...
function JobsPage() {
  ...
  const lockedCategory = String(handle.lockedCategory || '').trim()
  const pageTitle = String(handle.title || 'All Jobs')
  const showCategoryFilters = !lockedCategory
  ...
  const currentListQuery = useCallback(
    ...
    [page, debouncedSearch, lockedCategory, category]
  )
  ...
  }, [location.pathname, lockedCategory])
